...
class m2stock extends StatefulWidget {
  static const nameRoute = '/m2stock';
  const m2stock(String z, {super.key});

  @override
  State<m2stock> createState() => _m2stockState();
}

class _m2stockState extends State<m2stock> {
  ...
  Future<void> riwayatstockData() async {
    riwayatStockList = await getriwayatstock.gethistori(2);
  ...
  Future<void> processedData() async {
    stockProcessed = await getStockprocessed.getrecQuality(2);
            ...
            onPressed: () {
              AwesomeDialog(
                      ...
                      btnOkOnPress: () {
                        ...
                        if (tipeValue == "A") {
                          addStock.putStock(int.parse(jumlah.text), 0, 0, 2);
                          ...
                          addStock.putStock(0, int.parse(jumlah.text), 0, 2);
                          addriwayatStock.connectAPIPost(
                            2,
                            tipeValue.toString(),
                            int.parse(jumlah.text),
                          ...
                          addStock.putStock(0, 0, int.parse(jumlah.text), 2);
                          addriwayatStock.connectAPIPost(
                            2,
                            tipeValue.toString(),
                            int.parse(jumlah.text),
