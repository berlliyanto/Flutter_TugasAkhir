...
class m3cost extends StatefulWidget {
  static const nameRoute = '/m3cost';
  const m3cost(String ac, {super.key});
  ...
  @override
  State<m3cost> createState() => _m3costState();
}

class _m3costState extends State<m3cost> {
  late Timer timer;
  //LATEST COST
  ...
  Future<void> CostData() async {
    listCost = await latestCost.getCostList(3);
  ...
  Future<void> CostHData() async {
    listCostH = await latestCostH.getCostH(3);
