...
class m3oee extends StatefulWidget {
  static const nameRoute = '/m3oee';
  const m3oee(String ae, {super.key});

  @override
  State<m3oee> createState() => _m3oeeState();
}

class _m3oeeState extends State<m3oee> {
  late Timer timer;
  String? tipe;
  ...
  Future<void> Perdata() async {
    PList = await Performance.getPerform(3);
