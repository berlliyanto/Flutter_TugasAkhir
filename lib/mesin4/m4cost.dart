...
class m4cost extends StatefulWidget {
  ...
  @override
  State<m4cost> createState() => _m4costState();
}

class _m4costState extends State<m4cost> {
    late Timer timer;
  //LATEST COST
  ...
  Future<void> CostData() async {
    listCost = await latestCost.getCostList(4);
  ...
  Future<void> CostHData() async {
    listCostH = await latestCostH.getCostH(4);
