...
class m4monitoring extends StatelessWidget {
  static const nameRoute = '/m4monitoring';
  const m4monitoring(String aq, {super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text("Mesin 4 Monitoring",style: TextStyle(fontSize: blockVertical * 2.5),),
          centerTitle: true,
