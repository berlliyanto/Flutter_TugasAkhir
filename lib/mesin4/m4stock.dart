...
class m4stock extends StatefulWidget {
  static const nameRoute = '/m4stock';
  const m4stock(String ar, {super.key});

  @override
  State<m4stock> createState() => _m4stockState();
}

class _m4stockState extends State<m4stock> {
  ...
  Future<void> stockData() async {
    stockList = await getstockM1.getStock(4);
  ...
  Future<void> riwayatstockData() async {
    riwayatStockList = await getriwayatstock.gethistori(4);
  ...
  Future<void> processedData() async {
    stockProcessed = await getStockprocessed.getrecQuality(4);
            ...
            onPressed: () {
              AwesomeDialog(
                      ...
                      btnOkOnPress: () {
                        ...
                        if (tipeValue == "A") {
                          addStock.putStock(int.parse(jumlah.text), 0, 0, 4);
                          ...
                          addStock.putStock(0, int.parse(jumlah.text), 0, 4);
                          addriwayatStock.connectAPIPost(
                            4,
                            tipeValue.toString(),
                            int.parse(jumlah.text),
                          ...
                          addStock.putStock(0, 0, int.parse(jumlah.text), 4);
                          addriwayatStock.connectAPIPost(
                            4,
                            tipeValue.toString(),
                            int.parse(jumlah.text),
