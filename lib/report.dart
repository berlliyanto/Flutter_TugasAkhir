                                                  ...
                                                  ? (reportValue == "Parameter")
                                                      ...
                                                      : (reportValue == "OEE")
                                                          ...
                                                          : (reportValue ==
                                                                  "Production")
                                                              ? //ELSE IF()
                                                              ProductionMPDF(mid: 4).AMRP()
                                                              //MACHINE 4 & STOCK
                                                              : (reportValue ==
                                                                      "Stock")
                                                                  ? //ELSE IF()
                                                                  StockMPDF(mid: 4).AMRS()
                                                                  //MACHINE 4 & STOCK
                                                                  : (reportValue ==
                                                                          "Cost Price")
                                                                      ? //ELSE IF()
